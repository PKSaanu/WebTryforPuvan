    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 lg:hidden">
          <div className="w-full h-full bg-[url('/south-indian-woman-elegant-textile-saree.jpg')] 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl xl:text-8xl font-serif font-light text-foreground leading-tight">
                Lower Price
                <br />
            ...
            <p className="text-base sm:text-lg text-foreground/60 leading-relaxed max-w-lg font-light">
