        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-serif font-light text-foreground">
              Exclusive Holiday
              <br />
              <span className="text-gradient-cyan-gold">Collection</span>
            </h2>
          </div>

          {/* Description */}
          <p className="text-foreground/70 leading-relaxed font-light">
            Get <span className="text-accent font-semibold">25% OFF</span> on all new arrivals this season. Limited time
            offer exclusively for our valued customers.
          </p>

          {/* Countdown */}
          <div className="bg-accent/10 border border-accent/20 rounded-lg p-4">
            <p className="text-xs text-foreground/60 uppercase tracking-wide mb-2">Offer ends in:</p>
            <p className="text-2xl font-serif font-light text-accent">5 Days</p>
          </div>
