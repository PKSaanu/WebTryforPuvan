  ...
  return (
    <section id="location" className="py-32 px-4 sm:px-6 lg:px-8 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Map container */}
        <div className="relative rounded-2xl overflow-hidden shadow-2xl h-96 md:h-[500px] lg:h-[600px] bg-muted border-2 border-accent/30 hover:border-accent/60 transition duration-300 hover:shadow-[0_0_30px_rgba(0,217,255,0.2)]">
          ...
          {!isMapLoaded && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-muted/70 z-20">
              ...
              ></lord-icon>
              <p className="mt-4 text-foreground font-light text-lg">Loading Map...</p>
            </div>
          )}
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-3 p-6 rounded-xl bg-card border-2 border-accent/20 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10 transition">
            ...
            <p className="text-accent hover:text-secondary font-light text-base transition">
              Puthukudiyiruppu Town, Mullaitiv, Sri Lanka
            </p>
          </div>
          <div className="space-y-3 p-6 rounded-xl bg-card border-2 border-accent/20 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10 transition">
